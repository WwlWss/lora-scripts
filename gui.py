...
parser = argparse.ArgumentParser(description="Diffusion Trainer Studio GUI")
...
def launch():
    log.info("Starting Diffusion Trainer Studio GUI...")
    ...
    log.info(f"Diffusion Trainer Studio Version: {git_tag(base_dir_path())}")
